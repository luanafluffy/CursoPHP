<nav class="modulos">
    ...
    <div class="modulo roxo-escuro">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=includes&file=executando_desafio">
                    Desafio Include Com Classe
                </a>
            </li>
        </ul>
    </div>
    ...
    <div class="modulo verde-escuro">
        ...
        <ul>
            <li>
                <a href="exercicio.php?dir=repeticoes&file=desafio_tabela_1">
                    Desafio Tabela #01
                </a>
            </li>
        </ul>
    ...
    <div class="modulo roxo">
        ...
        <ul>
            <li>
                <a href="exercicio.php?dir=controle&file=desafio_switch_1">
                    Desafio Nº 1 Switch 
                </a>
            </li>
        </ul>
